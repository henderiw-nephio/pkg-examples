module github.com/example.com/foo
...
require (
	...
	github.com/nephio-project/nephio v0.0.0-20230411184616-160f37ee9959
	github.com/nephio-project/nephio-controller-poc v0.0.0-20221111013453-5a31b4722094
	github.com/nokia/k8s-ipam v0.0.4-0.20230314102244-10adc3598b30
	k8s.io/api v0.26.1
