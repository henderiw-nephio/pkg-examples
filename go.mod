module github.com/henderiw-nephio/pkg-examples

go 1.20

require (
	github.com/GoogleContainerTools/kpt v1.0.0-beta.30
	...
	github.com/nephio-project/nephio v0.0.0-20230421173715-e23510d07a06
